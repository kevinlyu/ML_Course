...
% train stage
poly_kernel = (trainFeature * trainFeature').^2;

[alpha1, bias1] = smo(poly_kernel, label1', C, tolerance);
[alpha2, bias2] = smo(poly_kernel, label2', C, tolerance);
[alpha3, bias3] = smo(poly_kernel, label3', C, tolerance);
...
y = [alpha1.*label1'*poly_kernel+bias1;  ...
    alpha2.*label2'*poly_kernel+bias2;  ...
    alpha3.*label3'*poly_kernel+bias3];
...
y1 = alpha1.*label1'*(((xy*trainFeature')').^2) + bias1;
y2 = alpha2.*label2'*(((xy*trainFeature')').^2) + bias2;
y3 = alpha3.*label3'*(((xy*trainFeature')').^2) + bias3;
...
% test stage
poly_kernel = (testFeature * trainFeature').^2;
